...
<title>Reset password · Kugawana</title>
...
<div class="login-split">
  ...
  <div class="login-form">
    ...
    <p class="text-muted" style="margin-bottom:32px">We'll email you a link to set a new one</p>
    ...
    <form method="POST" action="{{ route('password.email') }}">
      ...
      @enderror
      <button type="submit" class="btn btn-primary" style="justify-content:center;padding:12px;width:100%">Send reset link</button>
    </form>
