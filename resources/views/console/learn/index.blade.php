...
<div style="display:flex;justify-content:flex-end;margin-bottom:16px">
  <a class="btn btn-primary" href="{{ route('console.learn.create') }}">@include('console.partials.icon', ['name' => 'plus']) New article</a>
</div>
    ...
    <tbody>
      @forelse ($articles as $a)
        <tr>
          ...
          <td style="text-align:right"><a class="btn btn-ghost" href="{{ route('console.learn.edit', $a) }}">Edit</a></td>
        </tr>
      @empty
