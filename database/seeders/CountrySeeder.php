...
/**
 * Every country in the world, seeded inactive so the super admin picks which
 * ones Kugawana actually operates in from Console → Countries. Rows that
 * already exist (like the launch country) are left exactly as they are.
 */
class CountrySeeder extends Seeder
{
    public function run(): void
    {
        foreach (self::COUNTRIES as $code => [$name, $currency]) {
            Country::firstOrCreate(
                ['code' => $code],
                ['name' => $name, 'currency_code' => $currency, 'is_active' => false],
            );
        }
    }

    /** ISO 3166-1 alpha-2 => [name, ISO 4217 currency]. */
